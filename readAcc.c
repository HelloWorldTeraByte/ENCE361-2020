...
main (void)
{
    ...
    while (1)
    {
        ...
        //acceleration_raw = getAcclData();
        acceleration_ms2 = getAcclDataCmS2();
        ...
        displayUpdate ("Accl", "X", acceleration_ms2.x, 1);
        displayUpdate ("Accl", "Y", acceleration_ms2.y, 2);
        displayUpdate ("Accl", "Z", acceleration_ms2.z, 3);
    }
}
